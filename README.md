...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/arelle-release-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/arelle-release-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add arelle-release
# for installing globally
pixi global install arelle-release
```
...
It is possible to list all of the versions of `arelle-release` available on your platform:
...
```
pixi search arelle-release --channel conda-forge
```
